...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        leftcolor = tk.Label(self, height = 1260, width =550, bg = "Red1")
        leftcolor.place(x=0, y=0)
        label = tk.Label(self, text="STUDENT INFORMATION SYSTEM", bg= "Black", fg= "white", relief=RIDGE,font=("Calibri italic", 30))
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Courses",bg= "Red1", fg= "white",bd=0, font=("Calibri", 40, "bold"))
        ...
        student = tk.Button(self, text="STUDENTS",font=("Calibri",18,"bold"), height = 1, width = 12,relief=RIDGE, bg="Black", fg="white", command=lambda: controller.show(Students))
        student.place(x=20,y=170)
        
        
        self.lblccode = Label(self, font=("Calibri", 17, "bold"), text="Course Code:", bg= "Red1", fg= "white",bd=0, relief=RIDGE)
        self.lblccode.place(x=20,y=330)
        self.txtccode = Entry(self, font=("Calibri", 17), textvariable=Course_Code, width=35)
        self.txtccode.place(x=20,y=380)

        self.lblcname = Label(self, font=("Calibri", 17,"bold"), text="Course Name:",bg= "Red1", fg= "white",bd=0, relief=RIDGE, padx=5, pady=5)
        self.lblcname.place(x=20,y=230)
        self.txtcname = Entry(self, font=("Calibri", 17), textvariable=Course_Name, width=35)
        self.txtcname.place(x=20,y=280)
        
        self.SearchBar = Entry(self, font=("Calibri", 15), textvariable=SearchBar_Var, bd=3, width=20)
        ...
        self.adds = Button(self, text="Add", font=("Calibri",17,"bold"),bd=0,  width = 10, bg="Black", fg="white",command=add_course)
        self.adds.place(x=20,y=500)
        

        self.update = Button(self, text="Update", font=("Calibri",17,"bold"),bd=0,  width = 10, bg="Black", fg="white", command=update_course) 
        self.update.place(x=220,y=500)
        

        self.clear = Button(self, text="Clear", font=("Calibri",17,"bold"),bd=0,  width = 10, bg="Black", fg="white", command=clear)
        self.clear.place(x=420,y=500)
        


        self.delete = Button(self, text="Delete", font=("Calibri",17,"bold"),bd=0,  width = 10, bg="Black", fg="white", command=delete_course)
        self.delete.place(x=620,y=500)
        

        self.search = Button(self, text="Search", font=("Calibri",14,"bold"),bd=0,  width = 10, bg="Black", fg="white", command=search_course)
        self.search.place(x=1000,y=100)
        

        self.display = Button(self, text="Display", font=("Calibri",14,"bold"),bd=0,  width = 10, bg="Black", fg="white", command=display_course)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="STUDENT INFORMATION",bg= "Red1", fg= "white", relief=RIDGE, font=("Arial", 40, "bold"))
        label.place(x=320,y=20)
        
       
        
        course = tk.Button(self, text="COURSES",font=("Arial",18,"bold"), height = 1, width = 12,relief=RIDGE, bg="Black", fg="white", command=lambda: controller.show(Courses))
        course.place(x=900,y=465)
        course.config(cursor= "hand2")
        
        student = tk.Button(self, text="STUDENTS",font=("Arial",18,"bold"), height = 1, width = 12,relief=RIDGE, bg="Black", fg="white", command=lambda: controller.show(Students))
        ...
        self.lblid = Label(self, font=("Arial", 14, "bold"), text="ID Number:", bg= "Red1", fg= "white" )
        ...
        self.lblname = Label(self, font=("Arial", 14, "bold"), text="Name:", bg= "Red1", fg= "white")
        ...
        self.lblc = Label(self, font=("Arial", 14, "bold"), text="Course:", bg= "Red1", fg= "white")
        ...
        self.lblyear = Label(self,font=("Arial", 14, "bold"), text="Year Level:", bg= "Red1", fg= "white")
        ...
        self.lblgender = Label(self, font=("Arial", 14, "bold"), text="Gender:", bg= "Red1", fg= "white")
        ...
        self.SearchBar = Entry(self, font=("Arial", 11), textvariable=SearchBar_Var, bd=1, width=34)
        ...
        self.add = Button(self, text="ADD", font=("Arial", 16, "bold"), bg= "Black", fg= "white", padx= 20,bd=0, command=add_stud)
        self.add.place(x=35,y=408)
        self.add.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=("Arial", 16, "bold"), bg= "Black", fg= "white",padx= 10,bd=0, command=update_stud)
        self.update.place(x=175,y=408)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=("Arial", 16, "bold"), bg= "Black", fg= "white", padx= 10,bd=0,command=clear)
        self.clear.place(x=330,y=408)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=("Arial",16, "bold"), bg= "Black", fg= "white",padx= 6,bd=0, command=delete_stud)
        self.delete.place(x=460,y=408)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=("Arial", 14, "bold"),bd=0, bg= "Black", fg="white", command=search_stud)
        self.search.place(x=1060,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=("Arial", 14, "bold"),  bd=0, bg= "Black", fg="white",command = display_stud)
